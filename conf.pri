...
QMAKE_CXXFLAGS += -O2 -g -O2  -g 

EXTERNAL_INCLUDES = /usr/local/include  /usr/local/Cellar/libtorrent-rasterbar/1.1.11/include/libtorrent /usr/local/Cellar/libtorrent-rasterbar/1.1.11/include 
...
EXTERNAL_LIBS = -L/usr/local/lib  -lz -L/usr/local/Cellar/libtorrent-rasterbar/1.1.11/lib -ltorrent-rasterbar -lboost_system -lboost_system 
EXTERNAL_LIBS -= $$QMAKE_DEFAULT_LIBDIRS
LIBS += $$EXTERNAL_LIBS

CONFIG +=  release stacktrace
