...
QT_MOC_LITERAL(11, 162, 2), // "ip"
QT_MOC_LITERAL(12, 165, 8) // "hostname"
...
void PeerListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PeerListWidget *_t = static_cast<PeerListWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 7: _t->handleResolved((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}

const QMetaObject PeerListWidget::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_PeerListWidget.data,
      qt_meta_data_PeerListWidget,  qt_static_metacall, nullptr, nullptr}
};
