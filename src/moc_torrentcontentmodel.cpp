...
void TorrentContentModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TorrentContentModel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TorrentContentModel::filteredFilesChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TorrentContentModel::staticMetaObject = {
