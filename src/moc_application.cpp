...
QT_MOC_LITERAL(4, 36, 15), // "torrentFinished"
QT_MOC_LITERAL(5, 52, 31), // "BitTorrent::TorrentHandle*const"
QT_MOC_LITERAL(6, 84, 7), // "torrent"
QT_MOC_LITERAL(7, 92, 19), // "allTorrentsFinished"
QT_MOC_LITERAL(8, 112, 7) // "cleanup"

    },
    "Application\0processMessage\0\0message\0"
    "torrentFinished\0BitTorrent::TorrentHandle*const\0"
    "torrent\0allTorrentsFinished\0cleanup"
};
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->torrentFinished((*reinterpret_cast< BitTorrent::TorrentHandle*const(*)>(_a[1]))); break;
        case 2: _t->allTorrentsFinished(); break;
...
QT_INIT_METAOBJECT const QMetaObject Application::staticMetaObject = {
    { &BaseApplication::staticMetaObject, qt_meta_stringdata_Application.data,
...
void *Application::qt_metacast(const char *_clname)
{
    ...
    return BaseApplication::qt_metacast(_clname);
}

int Application::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = BaseApplication::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 4)
