...
#include "gui/search/searchjobwidget.h"
...
void SearchJobWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SearchJobWidget *_t = static_cast<SearchJobWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SearchJobWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SearchJobWidget.data,
      qt_meta_data_SearchJobWidget,  qt_static_metacall, nullptr, nullptr}
};
