...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Logger::*_t)(const Log::Msg & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Logger::newLogMessage)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Logger::*_t)(const Log::Peer & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Logger::newLogPeer)) {
                *result = 1;
                return;
            }
        }
