...
const QMetaObject RSS::Folder::staticMetaObject = {
    { &Item::staticMetaObject, qt_meta_stringdata_RSS__Folder.data,
      qt_meta_data_RSS__Folder,  qt_static_metacall, nullptr, nullptr}
};
