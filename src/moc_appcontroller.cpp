...
QT_MOC_LITERAL(4, 49, 14), // "shutdownAction"
QT_MOC_LITERAL(5, 64, 17), // "preferencesAction"
QT_MOC_LITERAL(6, 82, 20), // "setPreferencesAction"
QT_MOC_LITERAL(7, 103, 21) // "defaultSavePathAction"

    },
    "AppController\0webapiVersionAction\0\0"
    "versionAction\0shutdownAction\0"
    "preferencesAction\0setPreferencesAction\0"
    "defaultSavePathAction"
};
...
void AppController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->shutdownAction(); break;
        case 3: _t->preferencesAction(); break;
        case 4: _t->setPreferencesAction(); break;
        case 5: _t->defaultSavePathAction(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject AppController::staticMetaObject = {
    { &APIController::staticMetaObject, qt_meta_stringdata_AppController.data,
