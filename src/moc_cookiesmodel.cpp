...
const QMetaObject CookiesModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_CookiesModel.data,
      qt_meta_data_CookiesModel,  qt_static_metacall, nullptr, nullptr}
};
