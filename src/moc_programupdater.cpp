...
void ProgramUpdater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ProgramUpdater::*_t)(bool , QString , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgramUpdater::updateCheckFinished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ProgramUpdater::staticMetaObject = {
