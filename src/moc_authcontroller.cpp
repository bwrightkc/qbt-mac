...
#include "webui/api/authcontroller.h"
...
QT_MOC_LITERAL(1, 15, 11), // "loginAction"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 12) // "logoutAction"

    },
    "AuthController\0loginAction\0\0logoutAction"
};
...
void AuthController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loginAction(); break;
        case 1: _t->logoutAction(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject AuthController::staticMetaObject = {
    { &APIController::staticMetaObject, qt_meta_stringdata_AuthController.data,
      qt_meta_data_AuthController,  qt_static_metacall, nullptr, nullptr}
};
