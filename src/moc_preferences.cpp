...
QT_MOC_LITERAL(3, 21, 20), // "setStatusFilterState"
QT_MOC_LITERAL(4, 42, 7), // "checked"
QT_MOC_LITERAL(5, 50, 22), // "setCategoryFilterState"
QT_MOC_LITERAL(6, 73, 17), // "setTagFilterState"
QT_MOC_LITERAL(7, 91, 21), // "setTrackerFilterState"
QT_MOC_LITERAL(8, 113, 5) // "apply"

    },
    "Preferences\0changed\0\0setStatusFilterState\0"
    "checked\0setCategoryFilterState\0"
    "setTagFilterState\0setTrackerFilterState\0"
    "apply"
};
...
void Preferences::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setStatusFilterState((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->setCategoryFilterState((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->setTagFilterState((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->setTrackerFilterState((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Preferences::changed)) {
                *result = 0;
                return;
            }
        }
